var AVProVideoWebGL = {
    ...
    AVPPlayerInsertVideoElement: function (path, idValues, externalLibrary) {
        ...
        // NOTE: Uncomment these lines below to add hls.js support for HLS (m3u8)
        //       You need to copy hls.min.js and copy it into /Plugins/WebGL/ folder
        //       You need to rename it to hls.min.min.jspre
        //       The player will ONLY open HLS streams after this change
        ...
        {
            var options = {};
            var player = videojs(vid, options, function onPlayerReady() {
