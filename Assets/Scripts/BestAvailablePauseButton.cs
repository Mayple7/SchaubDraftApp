...
public class BestAvailablePauseButton : MonoBehaviour
{
	...
	private BestAvailableController bestAvailableScript;
	...
	void Start()
	{
		...
		bestAvailableScript = GameObject.Find("BestAvailableController").GetComponent<BestAvailableController>();
	...
	private void OnMouseUpAsButton()
	{
		if (currentSprite == pauseSprite)
		{
			...
			bestAvailableScript.TogglePause();
