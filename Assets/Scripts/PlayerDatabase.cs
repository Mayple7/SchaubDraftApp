...
public class PlayerDatabase
{
	...
	public void ImportPlayerData()
	{
		...
		while (!reader.EndOfStream)
		{
			...
			newData.playerName = playerFields[1].Replace(".", string.Empty);
			...
			// Incremeant the total imported players.
			++totalImportedPlayers;
		}
	...
	public PlayerData PickPlayerFromDatabase(string playerName)
	{
		...
		else
		{
			...
			newPlayer.overallRank = totalImportedPlayers + 1;
