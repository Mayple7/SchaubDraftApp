...
public class ContractReleaseButton : MonoBehaviour
{
	...
	// Button positions
	private Vector3 DisplayPosition = new Vector3(6.25f, 0, 0);
	private Vector3 HiddenPosition = new Vector3(10, 0, 0);
